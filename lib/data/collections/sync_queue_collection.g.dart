...
int _syncQueueCollectionEstimateSize(
  ...
  bytesCount += 3 + object.targetPeerId.length * 3;
  return bytesCount;
}
...
void _syncQueueCollectionSerialize(
  ...
  writer.writeString(offsets[5], object.targetPeerId);
}
...
SyncQueueCollection _syncQueueCollectionDeserialize(
  ...
  object.targetPeerId = reader.readString(offsets[5]);
  return object;
}
...
extension SyncQueueCollectionQueryFilter on QueryBuilder<SyncQueueCollection,
  ...
  QueryBuilder<SyncQueueCollection, SyncQueueCollection, QAfterFilterCondition>
      targetPeerIdContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'targetPeerId',
        value: value,
  ...
  QueryBuilder<SyncQueueCollection, SyncQueueCollection, QAfterFilterCondition>
      targetPeerIdMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'targetPeerId',
        wildcard: pattern,
...
extension SyncQueueCollectionQuerySortBy
  ...
  QueryBuilder<SyncQueueCollection, SyncQueueCollection, QAfterSortBy>
      sortByTargetPeerId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'targetPeerId', Sort.asc);
    });
  }

  QueryBuilder<SyncQueueCollection, SyncQueueCollection, QAfterSortBy>
      sortByTargetPeerIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'targetPeerId', Sort.desc);
    });
  }
}
...
extension SyncQueueCollectionQueryWhereDistinct
  ...
  QueryBuilder<SyncQueueCollection, SyncQueueCollection, QDistinct>
      distinctByTargetPeerId({bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'targetPeerId', caseSensitive: caseSensitive);
    });
  }
}
...
extension SyncQueueCollectionQueryProperty
  ...
  QueryBuilder<SyncQueueCollection, String, QQueryOperations>
      targetPeerIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'targetPeerId');
    });
  }
}
